...
Route::controller(TeacherDashboardController::class)->prefix('teacher')->middleware('isLoggedIn')->group(function () {
	...
	Route::get('result','get_student_single_result')->name('get_student_single_result_teacher');
	Route::post('score_update','score_update')->name('score_update_teacher');
...
Route::controller(AssessmentController::class)->prefix('admin/')->middleware('isLoggedIn')->group(function () {
	...
	Route::get('result','get_student_single_result')->name('get_student_single_result');
	Route::post('score_update','score_update')->name('score_update');
...
Route::controller(TeacherAttendanceController::class)->prefix('teacher')->middleware('isLoggedIn')->group(function () {
    ...
    Route::get('teacher_add_attendance/{c_id}/{su_id}/{st_id}/{t_id}','teacher_add_attendance')->name('teacher_add_attendance');
    Route::post('teacher_add_attendance_process','teacher_add_attendance_process')->name('teacher_add_attendance_process');

    Route::get('teacher_edit_attendance/{c_id}/{su_id}/{st_id}/{t_id}','teacher_edit_attendance')->name('teacher_edit_attendance');
    Route::get('teacher_list_attendance','teacher_list_attendance')->name('teacher_list_attendance');
    Route::post('teacher_edit_attendance_process','teacher_edit_attendance_process')->name('teacher_edit_attendance_process');
});
