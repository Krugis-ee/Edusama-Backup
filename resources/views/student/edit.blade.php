                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Edit Student</h4>
                        </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="navs-pills-justified-single" role="tabpanel">
                                            <div class="col-12 col-lg-12">
                                                <div class="mb-4">
                                                    <div class="card-body">
                                                        <form id="formAccountSettings" method="POST" action={{route('student_update');}} enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-6" id="student_parent">
                                                                    ...
                                                                    <select class="form-select" id="parent" name="parent" aria-label="Student Parent">
                                                                        ...
                                                                        if ($data->parent_id == $parent->id)
                                                                            ...
                                                                            $sele = '';
                                                                        echo '<option ' . $sele . ' value="' . $parent->id . '">' . $parent->first_name . $parent->last_name . '</option>'; ?>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('parent')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <a href="{{route('student_list')}}" class="btn btn-label-secondary">Discard</a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
