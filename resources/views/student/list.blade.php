            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    if (!in_array($user_role_id, $primary_roles)) {
                        ...
                        if (in_array('studentsCreate', $privileges_arr)) {
                            $show_add = 1;
                        }
                    }
                    //Add
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                            <div class="d-flex flex-column justify-content-center">
                                <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">List Students</h4>
                            </div>
                            <div class="d-flex align-content-center flex-wrap gap-3">
                                <div class="d-flex gap-3">
                                    <a href="{{ route('send_bulk_student_email') }}">
                                ...
                                <?php if ($show_add == 1) { ?>
                                    <div class="d-flex gap-3">
                                        <a href="{{ route('student_add','single') }}">
                                            <button class="btn btn-primary" type="button">
                                                <span>
                                                    <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                        ...
                        <input type="hidden" id="ajax_url" name="ajax_url" value="{{route('change_student_status')}}">
                        <?php
                        $user_id = session()->get('loginId');
                        $privileges = App\Models\UserPrivilege::getPrivilegesByUserId($user_id);
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php foreach ($students as $student) {
                                            ...
                                            // $branch_name = App\Models\Branch::getBranchNameByBranchId($student->branch_id);
                                            // echo '<td>' . $branch_name . '</td>';

                                            // $parent_name = App\Models\User::getParentNameByParentID($student->parent_id);

                                            // echo '<td>' . $parent_name . '</td>';

                                            // isset($student->birth_date) ? $dob = $student->birth_date->format('d-m-Y')  : $dob = NULL;
                                        ...
                                        ?>
                                            <td>
                                                ...
                                                if ($student->type == 2) {
                                                ?>
                                                    <span class="badge rounded-pill bg-danger" title="{{$student->suspend_msg}}" style="cursor: pointer;">Suspended</span>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($user_role_id == 1 || in_array('studentsUpdate', $all_privilege_arr)) { ?>
                                                    ...
                                                    <?php }
                                                if ($user_role_id == 1 || in_array('studentsDelete', $all_privilege_arr)) {
                                                    if ($student->type == 1) { ?>
                                                        <button style="border: none;">
                                                            <span data-bs-toggle="tooltip" title="Suspend" style="cursor: pointer; background-color:#ea5455" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $student->id }}" data-name="{{$student->first_name.' '.$student->last_name}}" data-type="{{$student->type}}">
                                                    ...
                                                    ?>
                                                        <button style="border: none;">
                                                            <span data-bs-toggle="tooltip" title="Activate" style="cursor: pointer; background-color:#28c76f" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $student->id }}" data-name="{{$student->first_name.' '.$student->last_name}}" data-type="{{$student->type}}">
                                                                <i class="ti ti-droplet-exclamation"></i>
                                                            </span>
                                                        </button>
                                                <?php }
                                        ...
                                        <div class="modal fade" id="org_suspend" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('change_student_status')}}" method="POST">
                                                        @csrf
