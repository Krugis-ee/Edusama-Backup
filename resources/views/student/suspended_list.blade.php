...
<head>
    ...
    <title>Suspended Students</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Suspended Students</h4>
                                ...
                                <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($students as $student) {
                                            ...
                                            echo '<td>' . $student->email . '<span class="spnTooltip">' . $student->suspend_msg . '</span></td>';
                                            echo '<td>' . $student->mobile_number . '</td>';
                                            
                                             $branch_name=App\Models\Branch::getBranchNameByBranchId($student->branch_id);
                                            echo '<td>' . $branch_name . '</td>';
											//                                             echo '<td><div class="couponcode">Reason
                                            //   <span class="coupontooltip">' . $student->suspend_msg . '</span>
                                            //   <!-- UPDATED -->
                                            // </div></td>';
                                            echo '<td>

                                     <button class="toggle-class btn btn-success" data-id="' . $student->id . '"> Activate </button>
                                     </td>';
                                            echo '</tr>';
                                        } ?>
