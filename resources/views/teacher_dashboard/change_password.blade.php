                                            ...
                                            <div class="col-12 col-lg-12">
                                                <div class="mb-4">
                                                    <div class="card-body">
                                                        ...
                                                        @endif
                                                        <form id="formAccountSettings" method="POST" action="{{route('change_password_process_teacher')}}" enctype="multipart/form-data">
                                                            @csrf
                                                            <p style="height: 2px;"></p>
                                                            ...
                                                            <div class="mt-6">
                                                                ...
                                                                <a href="{{route('my_profile_teacher')}}" class="btn btn-label-secondary">Discard</a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
