...
$teacher_avatar= !empty(App\Models\User::getTeacherAvatarById($user_id)) ? App\Models\User::getTeacherAvatarById($user_id) : '3.png';
?>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    ...
                    <img src="{{asset('assets/img/teacher_avatar/'.$teacher_avatar)}}" alt class="h-auto rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                    <a class="dropdown-item" href="pages-account-settings-account.html">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <span class="fw-medium d-block"><?php $user_id = Session()->get('loginId');
                                        echo $user_name = App\Models\User::getTeacherNameByID($user_id);
                                        ?></span>
                                    <small class="text-muted"><?php
                                                                echo $role_name = App\Models\User::getUserRoleNameByID($user_id);
                                                                ?></small>
                                </div>
                            </div>
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('my_profile_teacher') }}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{route('common_logout')}}">
