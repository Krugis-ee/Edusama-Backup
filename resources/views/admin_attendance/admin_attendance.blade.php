...
<body class="list_attendance">
                ...
                <div class="content-wrapper">
                        ...
                        <div class="app-ecommerce mb-4">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                <div class="d-flex flex-column justify-content-center">
                                    <h4 class="mb-1 mt-3" id="pagetitle">Student Attendance Lists</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select id="attendance_branch" class="form-select">
                                    ...
                                    <div class="col-md-4" id="classroom_attendance">
                                        ...
                                        <select id="attendance_classroom" class="form-select">
                                            <option>-Select-</option>
                                            <option value="1">All</option>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                            ...
                                                            <div class="modal-body" style="text-align: left;">
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" id="Teacher" value="Teacher 1" readonly />
                                                                    </div>
                                                                    <div class="col mb-2">
                                                ...
                                                <div data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" class="badge badge-center bg-warning adminattendance_lists" style="cursor:pointer;" data-value="edit">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" class="badge badge-center bg-warning adminattendance_lists" style="cursor:pointer;">
                                                    <i class="ti ti-edit"></i>
                                                </span>
                                            </td>
                                        </tr>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y" id="student_attendances">
                        <div class="app-ecommerce mb-3">
                            ...
                            <div class="grid mt-4" id="attendance_grid">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#classroom_attendance').hide();

            $('#attendance_branch').change(function() {

                $(this).find("option:selected").each(function() {
                    var optionValue2 = $(this).attr("value");
                    if (optionValue2) {
                        $('#classroom_attendance').show();
