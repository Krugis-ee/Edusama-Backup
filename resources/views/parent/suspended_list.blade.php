            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Suspended Parents</h4>
                                ...
                                <table id="example"  class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($parents as $parent) {
                                            ...
                                            echo '<td>' . $parent->email . '<span class="spnTooltip">' . $parent->suspend_msg . '</span></td>';
                                            echo '<td>' . $parent->mobile_number . '</td>';
                                            echo '<td>
                                     <button class="toggle-class btn btn-success" data-id="' . $parent->id . '"> Activate</button>
                                     </td>';
