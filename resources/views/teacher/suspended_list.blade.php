...
<head>
    ...
    <title>Suspended Lectures</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Suspended Teachers</h4>
                                ...
                                <table id="example" data-order='[[ 0, "desc" ]]' class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($teachers as $teacher) {
                                            ...
                                            echo '<td>' . $teacher->email . '<span class="spnTooltip">' . $teacher->suspend_msg . '</span></td>';
                                            ...
                                            //   <span class="coupontooltip">' . $teacher->suspend_msg . '</span>
                                            //   <!-- UPDATED -->
                                            // </div></td>';
                                            echo '<td>

                                     <button class="toggle-class btn btn-success" data-id="' . $teacher->id . '"> Activate </button>
                                     </td>';
                                            echo '</tr>';
                                        } ?>
