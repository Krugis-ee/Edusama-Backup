                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="app-ecommerce mb-4">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                <div class="d-flex flex-column justify-content-center">
                                    <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">List Branches</h4>
                                </div>
                                <?php
                                $show_add = 1;
                                ?>
                        ...
                        <div class="card">
                            <div class="card-body table_admin text-nowrap">
                                ...
                                @endif
                                <input type="hidden" id="ajax_url" name="ajax_url" value="{{route('branch_change_status')}}">
                                <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($branch->type == 1) { ?>
                                                    <span class="badge rounded-pill bg-success">Active</span>
                                                <?php }
                                                if ($branch->type == 2) {
                                                ?>
                                                    <span class="badge rounded-pill bg-danger" title="{{$branch->suspend_msg}}" style="cursor: pointer;">Suspended</span>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <a href="{{ route('branch_edit',$branch->id) }}"><span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" class="badge badge-center bg-warning">
                                                        <i class="ti ti-edit"></i>
                                                    </span></a>
                                                <?php if ($branch->type == 1) { ?>
                                                    <button style="border: none;">
                                                        <span data-bs-toggle="tooltip" title="Suspend" style="cursor: pointer; background-color:#ea5455" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $branch->id }}" data-name="{{$branch->branch_name}}" data-type="{{$branch->type}}">
                                                ...
                                                ?>
                                                    <button style="border: none;">
                                                        <span data-bs-toggle="tooltip" title="Activate" style="cursor: pointer; background-color:#28c76f" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $branch->id }}" data-name="{{$branch->branch_name}}" data-type="{{$branch->type}}">
                                                            <i class="ti ti-droplet-exclamation"></i>
                                                        </span>
                                                    </button>
                                                <?php } ?>
                                        ...
                                        <div class="modal fade" id="org_suspend" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('branch_change_status')}}" method="POST">
                                                        @csrf
