...
<html
   ...
   <head>
      ...
      <title>Suspended Branches</title>
            ...
            <div class="layout-page">
              ...
              <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                 <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Suspended Branches</h4>
                     ...
                     <table id="example" class="display nowrap" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$branch->org_name; }}<span class="spnTooltip">{{$branch->suspend_msg}}</span></td>
                                <td>
                                  <button class="toggle-class btn btn-success" data-id="{{$branch->id }}"> Activate</button>
                               </td>
                            </tr>
