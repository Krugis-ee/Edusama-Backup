                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="app-ecommerce mb-4">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                <div class="d-flex flex-column justify-content-center">
                                    <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">List Users</h4>
                                </div>
                                <?php
                                $show_add = 0;
                                $show_edit = 0;
                                ...
                                <?php if ($show_add == 1) { ?>
                                    <div class="d-flex align-content-center flex-wrap gap-3">
                                        <div class="d-flex gap-3">
                                            <a href="{{ route('other_user_add_get') }}">
                        ...
                        <div class="card">
                            <div class="card-body table_admin text-nowrap">
                                ...
                                @endif
                                <input type="hidden" id="ajax_url" name="ajax_url" value="{{route('other_user_change_user_status')}}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ App\Models\UserRole::getRoleNameByID($user->user_role_id) }}

                                            </td>
                                            <td>{{App\Models\Branch::getBranchNameByBranchId($user->branch_id)}}</td>
                                            <td>
                                                <?php if ($user->type == 1) { ?>
                                                ...
                                                if ($user->type == 2) {
                                                ?>
                                                    <span class="badge rounded-pill bg-danger" title="{{$user->suspend_msg}}" style="cursor: pointer;">Suspended</span>
                                                <?php } ?>
                                            </td>

                                            <td>
                                                <a href="{{ route('other_user_edit',$user->id) }}"> <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" class="badge badge-center bg-warning">
                                        ...
                                        <div class="modal fade" id="org_suspend" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('other_user_change_user_status')}}" method="POST">
                                                        @csrf
