...
<head>
    ...
    <title>Change Admin Status</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: #e00814;">Change Admin Status</h4>
                        </div>
                        <!-- Add Product -->
                        <form method="POST" action={{route('change_user_status');}} enctype="multipart/form-data">
                            @csrf
