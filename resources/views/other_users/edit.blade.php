                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Edit User</h4>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="orgFormControlSelect" class="form-label">Select User Role</label>
                                ...
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                                    <div class="d-flex align-content-center flex-wrap gap-3">
                                        <div class="d-flex gap-3">
                                            ...
                                            <a href="{{route('other_user_index')}}" class="btn btn-label-secondary">Discard</a>
                                        </div>
