...
<div class="login_page">
      ...
      <div class="authentication-inner row">
        ...
        <div class="d-flex col-12 col-lg-6 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('common_login'); }}" method="POST">
              <div class="mb-3">
    ...
    togglePassword.addEventListener("click", function () {
        ...
        icon = $(this);
          if(icon.hasClass("ti-eye-off"))
            icon.addClass("ti-eye").removeClass("ti-eye-off");
            else
            icon.addClass("ti-eye-off").removeClass("ti-eye");
