<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item <?php if ((Request::url() === route('parent_dashboard'))) {
                                    echo 'active';
                                } ?>">
            <a href="{{route('parent_dashboard')}}" class="menu-link">
                <i class="menu-icon icon_resize tf-icons ti ti-smart-home"></i>
                <div data-i18n="Dashboard">Dashboard</div>
                <div class="badge bg-primary rounded-pill ms-auto">5</div>
            </a>
        </li>
        <li class="menu-item <?php if ((Request::url() === route('my_profile_parent'))) {
                                    echo 'active';
                                } ?>">
            <a href="{{ route('my_profile_parent') }}" class="menu-link">
        ...
        <li class="menu-header small text-uppercase">
          ...
          <li class="menu-item <?php if ((Request::url() === route('parent_assignment'))) {
                                    echo 'active';
                                } ?>">
            <a href="{{ route('parent_assignment') }}" class="menu-link">
              <i class="menu-icon icon_resize tf-icons ti ti-brand-stackoverflow"></i>
              <div data-i18n="Assignments">Assignments</div>
            </a>
          </li>
		  <li class="menu-item <?php if ((Request::url() === route('parent_assessment')) ) {
                                            echo 'active';
                                        } ?>">
            <a href="{{ route('parent_assessment') }}" class="menu-link">
