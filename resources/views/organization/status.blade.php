...
<head>
    ...
    <title>Change Organization Status</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: #e00814;">Change_organization_Status</h4>
                        </div>
                        <!-- Add Product -->
                        <form method="POST" action={{route('change_organization_status');}} enctype="multipart/form-data">
                            @csrf
