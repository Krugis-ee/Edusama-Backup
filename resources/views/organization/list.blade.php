                        ...
                        <div class="app-ecommerce">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                <div class="d-flex flex-column justify-content-center">
                                    <h4 class="mb-1 mt-3" style="color: #e00814;">List Organisations</h4>
                                </div>
                                <div class="d-flex align-content-center flex-wrap gap-3">
                                    <div class="d-flex gap-3">
                                        <a href="{{ route('organization_add'); }}" class="btn btn-primary">
                                            <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Organisation</span></span>
                                        </a>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($organizations as $organization) {
                                            ...
                                            if ($organization->type == 2)
                                                echo '<td><span class="badge rounded-pill bg-danger" title="' . $organization->suspend_msg . '" style="cursor: pointer;">Suspended</span></td>';


                                            echo '<td>
								 <a href="' . route("organization_edit", $organization->id) . '">
                                            ...
                                            if ($organization->type == 1) { ?>
                                                <button style="border: none;">
                                                    <span data-bs-toggle="tooltip" title="Suspend" style="cursor: pointer; background-color:#ea5455" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $organization->id }}" data-name="{{ $organization->name}}" data-type="{{$organization->type}}">
                                            ...
                                            ?>
                                                <button style="border: none;">
                                                    <span data-bs-toggle="tooltip" title="Activate" style="cursor: pointer; background-color:#28c76f" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $organization->id }}" data-name="{{ $organization->name}}" data-type="{{$organization->type}}">
                                                        <i class="ti ti-droplet-exclamation"></i>
                                                    </span>
                                                </button>
                                        <?php }
                                        ...
                                        <div class="modal fade" id="org_suspend" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('change_organization_status')}}" method="POST">
                                                        @csrf
