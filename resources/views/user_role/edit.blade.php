                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: #e00814;">Edit User Role</h4>
                        </div>
                        <!-- Add Product -->
                        <form method="POST" action={{route('user_role_update');}} enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    <div class="mb-3">
                                                        <label for="defaultFormControlInput" class="form-label"> User Role</label>
                                                        <input type="text" class="form-control" name="role_name" id="defaultFormControlInput" value="{{ $data->role_name; }}" placeholder="Role" aria-describedby="defaultFormControlHelp" />
