...
<html
   ...
   <head>
      ...
      <style type="text/css">
         ...
         .user_roles .form-control:focus, .user_roles .form-select:focus,.user_roles .input-group:focus-within .form-control, .user_roles .input-group:focus-within .input-group-text{
         border-color: #e00814 !important;
         }
         .user_roles .form-check-input:checked,.user_roles .form-check-input[type=checkbox]:indeterminate{
         background-color: #e00814 !important;
         border-color: #e00814 !important;
         }
            ...
            <div class="layout-page">
              ...
              <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                  <h4 class="mb-4">User Privileges</h4>
                  <!-- Role cards -->
                  <div class="row g-4">
                           ...
                           <div class="card-body">
                              ...
                              <div class="d-flex justify-content-between align-items-end mt-1">
                                 <div class="role-heading">
                                    ...
                                    data-bs-target="#editUserPrivileges_<?php echo $user_role->id; ?>"
                                    class="role-edit-modal"
                                    ><span>Edit User Privileges</span></a
                                    >
                              </div>
                        ...
                        <div class="modal-content p-3 p-md-5" style="padding: 3rem 0rem !important;">
                           ...
                           <div class="modal-body">
                              <div class="text-center mb-4">
                                 <h3 class="role-title mb-2">Edit User Privileges</h3>
                              </div>
                              <!-- Add role form -->
                                          ...
                                          <tbody>
                                             <tr>
                                                <td colspan="2" class="text-nowrap fw-medium">
                                                   <h5 style="color: #e00814 !important;"><b>Department + Role Name</b></h5>
                                                </td>
                                             </tr>
                                             <tr>
                                                ...
                                                <td>
                                                   <div class="form-check">
                                                      <input class="form-check-input selectAll" type="checkbox" data-roleid="{{ $user_role->id }}" id="selectAll_<?php echo $user_role->id; ?>" />
                                                      <label class="form-check-label" for="selectAll"> Select All </label>
                                                   </div>
                                                </td>
                                             </tr>
                                             <tr style="background-color: #d3d3d34a;">
                                                <td colspan="2" class="text-nowrap fw-medium"><small class="text-light fw-medium text-uppercase">&nbsp;&nbsp;&nbsp;Overview</small></td>
                                             </tr>
                                             <?php if(in_array('dashboard',$stie_config_arr)) { ?>
                                             <tr>
                                                <td class="text-nowrap fw-medium">Dashboard</td>
                                                <td>
                                                   <div class="d-flex">
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" id="dashboardCreate" name="user_privilege[]" />
                                                         <label class="form-check-label" for="dashboardCreate"> Create </label>
                                                      </div>
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="dashboardRead" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="dashboardRead"> Read </label>
                                                      </div>
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="dashboardUpdate" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="dashboardUpdate"> Update </label>
                                                      </div>
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="dashboardDelete" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="dashboardDelete"> Suspend </label>
                                                      </div>
                                                   </div>
                                                </td>
                                             </tr>
                                             <?php } ?>
                                             <?php if(in_array('profile',$stie_config_arr)) { ?>
                                             <tr>
                                                <td class="text-nowrap fw-medium">Profile</td>
                                                <td>
                                                   <div class="d-flex">
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="profileCreate" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="profileCreate"> Create </label>
                                                      </div>
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="profileRead" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="profileRead"> Read </label>
                                                      </div>
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="profileUpdate" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="profileUpdate"> Update </label>
                                                      </div>
                                                      <div class="form-check me-3 me-lg-5">
                                                         <input class="form-check-input checkboxes_<?php echo $user_role->id; ?>" type="checkbox" value="profileDelete" name="user_privilege[]"/>
                                                         <label class="form-check-label" for="profileDelete"> Suspend </label>
                                                      </div>
                                                   </div>
                                                </td>
                                             </tr>
