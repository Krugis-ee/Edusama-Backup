                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="app-ecommerce mb-4">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                <div class="d-flex flex-column justify-content-center">
                                    <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">List Departments</h4>
                                </div>
                                <?php
                                $show_add = 0;
                                $show_edit = 0;
                                ...
                                if (!in_array($user_role_id, $primary_roles)) {
                                    ...
                                    if (in_array('departmentsCreate', $privileges_arr)) {
                                        $show_add = 1;
                                    }
                                }
                                //Add
                                ...
                                <?php if ($show_add == 1) { ?>
                                    <div class="d-flex align-content-center flex-wrap gap-3">
                                        <div class="d-flex gap-3">
                                            <a href="{{ route('department_add_get') }}">
                        ...
                        <div class="card">
                            <div class="card-body table_admin text-nowrap">
                                ...
                                @endif
                                <input type="hidden" id="ajax_url" name="ajax_url" value="{{route('department_change_status')}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($department->branch_id)
                                                    $branch_name = App\Models\Branch::getBranchNameByBranchId($department->branch_id);
                                                echo $branch_name;
                                                ?></td>
                                            <td>
                                                ...
                                                ?>
                                                    <span class="badge rounded-pill bg-danger" title="{{$department->suspend_msg; }}" style="cursor: pointer;">Suspended</span>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($user_role_id == 1 || in_array('departmentsUpdate', $privileges_arr)) { ?>
                                                ...
                                                <?php }
                                                if ($user_role_id == 1 || in_array('departmentsDelete', $privileges_arr)) {
                                                ?>
                                                    <?php if ($department->type == 1) { ?>
                                                        <button style="border: none;">
                                                            <span data-bs-toggle="tooltip" title="Suspend" style="cursor: pointer; background-color:#ea5455" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $department->id }}" data-name="{{ $department->department_name}}" data-type="{{$department->type}}">
                                                    ...
                                                    ?>
                                                        <button style="border: none;">
                                                            <span data-bs-toggle="tooltip" title="Activate" style="cursor: pointer; background-color:#28c76f" data-bs-placement="bottom" id="suspend" class="badge badge-center toggle-class" data-id="{{ $department->id }}" data-name="{{ $department->department_name}}" data-type="{{$department->type}}">
                                                                <i class="ti ti-droplet-exclamation"></i>
                                                            </span>
                                                        </button>
                                                <?php }
                                        ...
                                        <div class="modal fade" id="org_suspend" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('department_change_status')}}" method="POST">
                                                        @csrf
