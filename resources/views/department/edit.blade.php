                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Edit Department</h4>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    ...
                                                    <select id="branch_id" name="branch_id" class="select2 form-select">
                                                        ...
                                                        if ($department->branch_id == $branch->id)
                                                            ...
                                                            $sel = '';
                                                        ?>
                                                        <option <?php echo $sel; ?> value="{{$branch->id}}">{{$branch->branch_name}} </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="department_name" required class="form-label">Department Name</label><span class="text-danger">*</span>
                                                        <input type="text" class="form-control" id="adminname" name="department_name" value="{{ $department->department_name; }}" placeholder="John Doe" aria-describedby="defaultFormControlHelp" />
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    <input type="text" class="form-control" placeholder="YYYY-MM-DD to YYYY-MM-DD" id="flatpickr-range" style="display:none;" />
                                                    <div class="mb-3">
                                                        <label for="short_code" required class="form-label">Department Short Code</label><span class="text-danger">*</span>
                                                        <input type="text" class="form-control" id="adminname" name="short_code" value="{{ $department->short_code; }}" placeholder="Short Code" aria-describedby="defaultFormControlHelp" />
                                                    </div>
                                ...
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                                    <div class="d-flex align-content-center flex-wrap gap-3">
                                        <div class="d-flex gap-3">
                                            ...
                                            <a href="{{route('department_index')}}" class="btn btn-label-secondary">Discard</a>
                                        </div>
