...
<html
   ...
   <head>
      ...
      <title>Suspended Subjects</title>
            ...
            <div class="layout-page">
              ...
              <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                 <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Suspended Subjects</h4>
                     ...
                     <table id="example" class="display nowrap" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$subject->org_name; }}<span class="spnTooltip">{{$subject->suspend_msg}}</span></td>
                                <td>
                                  <button class="toggle-class btn btn-success" data-id="{{$subject->id }}"> Activate</button>
                               </td>
                            </tr>
