                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Add Department</h4>
                        </div>
                        <form action="{{ route('department_add') }}" name="add_subject" method="post">
                            @csrf
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @enderror
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    <div class="mb-3">
                                                        <label for="subject_name" required class="form-label">Department Name</label><span class="text-danger">*</span>
                                                        <input type="text" class="form-control" id="department_name" name="department_name" placeholder="Department" value="{{ old('subject_name')}}" aria-describedby="defaultFormControlHelp" />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="short_code" name="short_code" placeholder="Department" value="{{ old('short_code')}}" aria-describedby="defaultFormControlHelp" />
                                                        @error('short_code')
                                                        <span style="color:red;">{{ $message }}</span>
                                                        @enderror
                                                    </div>
