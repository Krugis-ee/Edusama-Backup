                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-1 mt-3" style="color: <?php echo $org_color; ?>;">Edit Subject</h4>
                        </div>
                        <form action="{{ route('subject_update') }}" name="edit_admin" method="post">
                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    ...
                                                    <select id="branch_id" name="branch_id" class="select2 form-select">
                                                        ...
                                                        <?php
                                                        if ($subject->branch_id == $branch->id)
                                                            $sel = 'selected';
                                                        else
                                                            $sel = '';
                                                        ?>
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="adminname" name="subject_name" value="{{ $subject->subject_name; }}" placeholder="John Doe" aria-describedby="defaultFormControlHelp" />
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xl-12 col-12 mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="adminname" name="short_code" value="{{ $subject->short_code; }}" placeholder="Short Code" aria-describedby="defaultFormControlHelp" />
                                                    </div>
                                ...
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                                    <div class="d-flex align-content-center flex-wrap gap-3">
                                        <div class="d-flex gap-3">
                                            ...
                                            <a href="{{route('subject_index')}}" class="btn btn-label-secondary">Discard</a>
                                        </div>
